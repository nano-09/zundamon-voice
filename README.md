...
| 📊 ダッシュボード | 管理画面でBotの状態や統計をリアルタイム監視 |
...
1. [**`InstallZundamon.exe` をダウンロード**](https://github.com/nano-09/zundamon-voice/raw/main/InstallZundamon.exe) し、起動します。

<details>
<summary>🍎 macOS でインストールする手順</summary>

1. [**`InstallZundamon.command` をダウンロード**](https://github.com/nano-09/zundamon-voice/raw/main/InstallZundamon.command) し、ダブルクリックします。
